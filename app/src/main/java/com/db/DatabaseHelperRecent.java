...
public class DatabaseHelperRecent extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "recfavoriteallstory.db";
    ...
    public ArrayList<ItemStory> getFavourite() {
        ...
        String selectQuery = "SELECT *  FROM "
                + TABLE_FAVOURITE_NAME + " ORDER BY auto_id DESC limit 3";
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public ArrayList<ItemStory> getFavouriteAll() {
        ArrayList<ItemStory> chapterList = new ArrayList<>();
        String selectQuery = "SELECT *  FROM "
